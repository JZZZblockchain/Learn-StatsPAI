...
At a glance: 1,135 registered functions across 87 submodules; 339k LOC (core) + 182k LOC (tests). Run `python scripts/registry_stats.py` to reproduce these numbers.
