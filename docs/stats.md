...
| `synth` | 26,882 | 35 | 55 |
| `rd` | 20,103 | 31 | 53 |
| `regression` | 18,918 | 23 | 39 |
| `smart` | 15,886 | 20 | 31 |
| `forest` | 15,803 | 17 | 31 |
| `output` | 12,784 | 21 | 40 |
| `agent` | 12,541 | 32 | 4 |
| `matching` | 10,317 | 15 | 25 |
| `core` | 9,915 | 15 | 5 |
| `decomposition` | 9,772 | 19 | 32 |
| `dml` | 8,645 | 23 | 16 |
| `iv` | 8,533 | 17 | 10 |
...
| `multilevel` | 5,271 | 9 | 11 |
| `bayes` | 5,183 | 12 | 20 |
| `mendelian` | 5,163 | 13 | 41 |
| `frontier` | 4,980 | 8 | 12 |
| `workflow` | 4,478 | 5 | 3 |
| `metalearners` | 4,473 | 9 | 23 |
| `gmm` | 4,179 | 12 | 4 |
| `survival` | 4,162 | 6 | 15 |
| `qte` | 4,140 | 9 | 13 |
| `causal_discovery` | 4,077 | 11 | 20 |
| `tmle` | 3,573 | 6 | 11 |
| `structural` | 3,562 | 9 | 12 |
| `dag` | 3,556 | 9 | 23 |
| `network` | 3,514 | 9 | 33 |
| `neural_causal` | 3,330 | 6 | 18 |
| `robustness` | 3,098 | 6 | 11 |
| `causal_llm` | 2,968 | 10 | 15 |
| `bounds` | 2,793 | 5 | 12 |
| `crossval` | 2,755 | 7 | 2 |
| `bartik` | 2,583 | 5 | 8 |
| `conformal_causal` | 2,527 | 9 | 21 |
| `epi` | 2,510 | 6 | 20 |
| `rlasso` | 2,476 | 7 | 10 |
...
| `bunching` | 1,441 | 5 | 8 |
| `power` | 1,436 | 3 | 12 |
| `nonparametric` | 1,395 | 4 | 7 |
| `bridge` | 1,323 | 8 | 2 |
| `principal_strat` | 1,214 | 2 | 3 |
| `survey` | 1,182 | 4 | 7 |
| `experimental` | 1,175 | 4 | 9 |
