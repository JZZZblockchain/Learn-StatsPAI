...
>
> *StatsPAI live numbers last measured: 2026-06-02 on macOS arm64 against the local `statspai` 1.16.1 source tree. External ecosystem comparison rows are retained from the 2026-05-03 measurement unless noted otherwise.*
>
