...
>
> *StatsPAI live numbers last measured: 2026-06-18 on macOS arm64 against the local `statspai` 1.18.0 source tree (post schema/protocol sync). External ecosystem comparison rows are retained from the 2026-05-03 measurement unless noted otherwise.*
>
...
| ------------------------------------ | ---------- | -----: | ------------: | ---------------------------------- |
| **StatsPAI** `src/statspai/`         | measured   |    657 |   **309,709** | validation-tiered causal inference |
| StatsPAI tests (`tests/`)            | measured   |    854 |       156,357 | —                                  |
...
| `did` | 19,428 | 33 | 60 |
| `rd` | 15,208 | 25 | 53 |
| `regression` | 14,448 | 20 | 37 |
| `output` | 11,684 | 21 | 40 |
| `agent` | 9,944 | 30 | 0 |
| `smart` | 9,430 | 17 | 26 |
| `decomposition` | 8,239 | 18 | 31 |
| `fast` | 7,214 | 15 | 0 |
| `iv` | 6,864 | 16 | 8 |
| `diagnostics` | 6,781 | 12 | 25 |
| `matching` | 6,716 | 11 | 25 |
| `spatial` | 6,103 | 29 | 35 |
| `panel` | 5,753 | 12 | 17 |
| `inference` | 5,496 | 15 | 24 |
| `core` | 5,273 | 10 | 2 |
| `plots` | 5,238 | 6 | 6 |
| `frontier` | 4,702 | 8 | 12 |
| `bayes` | 4,635 | 10 | 17 |
| `dml` | 4,497 | 12 | 14 |
| `multilevel` | 4,380 | 8 | 11 |
| `mendelian` | 4,216 | 13 | 38 |
| `causal_discovery` | 3,970 | 11 | 20 |
| `workflow` | 3,956 | 5 | 3 |
| `metalearners` | 3,748 | 8 | 23 |
| `dag` | 3,344 | 9 | 23 |
| `timeseries` | 3,303 | 9 | 20 |
| `survival` | 3,188 | 6 | 12 |
| `tmle` | 3,102 | 6 | 11 |
| `neural_causal` | 3,077 | 6 | 16 |
| `structural` | 2,986 | 9 | 12 |
| `forest` | 2,972 | 5 | 8 |
| `causal_llm` | 2,816 | 10 | 11 |
| `robustness` | 2,600 | 6 | 11 |
| `bounds` | 2,464 | 5 | 9 |
| `conformal_causal` | 2,414 | 9 | 19 |
| `epi` | 2,318 | 6 | 20 |
| `interference` | 2,312 | 10 | 20 |
| `utils` | 2,104 | 8 | 32 |
| `bartik` | 2,074 | 4 | 8 |
| `proximal` | 1,863 | 8 | 13 |
| `question` | 1,847 | 3 | 6 |
| `qte` | 1,759 | 6 | 12 |
| `postestimation` | 1,703 | 4 | 12 |
| `bcf` | 1,530 | 5 | 8 |
| `fairness` | 1,400 | 3 | 6 |
| `target_trial` | 1,398 | 7 | 9 |
| `causal_text` | 1,382 | 4 | 4 |
| `bunching` | 1,362 | 5 | 8 |
| `power` | 1,356 | 3 | 12 |
| `mediation` | 1,351 | 4 | 6 |
| `bridge` | 1,309 | 8 | 2 |
| `policy_learning` | 1,308 | 3 | 7 |
| `principal_strat` | 1,135 | 2 | 3 |
| `experimental` | 1,055 | 4 | 9 |
| `datasets` | 1,018 | 2 | 0 |
| `causal_rl` | 991 | 5 | 9 |
| `surrogate` | 961 | 2 | 3 |
| `ope` | 952 | 3 | 3 |
| `survey` | 929 | 4 | 7 |
| `gmm` | 921 | 3 | 2 |
| `longitudinal` | 908 | 3 | 7 |
| `selection` | 884 | 2 | 3 |
| `dtr` | 883 | 5 | 2 |
| `gformula` | 848 | 3 | 4 |
| `dose_response` | 841 | 3 | 5 |
| `deepiv` | 793 | 2 | 2 |
| `mht` | 751 | 2 | 6 |
| `transport` | 736 | 5 | 8 |
| `msm` | 711 | 2 | 3 |
| `assimilation` | 681 | 3 | 2 |
| `causal_impact` | 641 | 2 | 3 |
| `nonparametric` | 584 | 3 | 4 |
| `fixest` | 574 | 3 | 4 |
| `imputation` | 487 | 2 | 3 |
| `matrix_completion` | 419 | 2 | 2 |
| `compat` | 376 | 2 | 0 |
| `multi_treatment` | 359 | 2 | 2 |
| `censoring` | 330 | 2 | 2 |
| `causal` | 102 | 1 | 0 |
| `schemas` | 0 | 0 | 0 |
| **Total** | **309,709** | **657** | **1070** |
