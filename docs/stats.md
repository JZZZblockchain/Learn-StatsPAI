...
>
> *StatsPAI live numbers last measured: 2026-06-01 on macOS arm64 against the local `statspai` 1.16.1 source tree. External ecosystem comparison rows are retained from the 2026-05-03 measurement unless noted otherwise.*
>
...
| ------------------------------------ | ---------- | -----: | ------------: | ---------------------------------- |
| **StatsPAI** `src/statspai/`         | measured   |    647 |   **269,010** | validation-tiered causal inference |
| StatsPAI tests (`tests/`)            | measured   |    529 |        96,467 | —                                  |
