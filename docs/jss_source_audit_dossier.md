...
econometrics. The live registry reports 1,249 registered public functions
...
Current JSS source-snapshot audit counts: 414 `certified`, 142 `validated`, 690 `api_stable`, and 3 `experimental` registry symbols. The certified/validated
surface is therefore 556 symbols, while 597 stable auto-registered symbols
