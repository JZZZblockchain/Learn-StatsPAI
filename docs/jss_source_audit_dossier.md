...
econometrics. The live registry reports 1,195 registered public functions
...
Current JSS source-snapshot audit counts: 414 `certified`, 130 `validated`, 648 `api_stable`, and 3 `experimental` registry symbols. The certified/validated
surface is therefore 544 symbols, while 555 stable auto-registered symbols
...
The source-snapshot evidence audit checks that all 544 certified/validated symbols
...
The current source snapshot also tracks 483 registry-evidence source files
