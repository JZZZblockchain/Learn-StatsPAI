...
| `conley` | [`test_conley_parity.py`](../tests/reference_parity/test_conley_parity.py) |
...
| `knn_weights` | [`test_geary_parity.py`](../tests/reference_parity/test_geary_parity.py) (+1) |
