...
| | aligned | 24 |
| | **subtotal** | **224** |
| **No external software reference** | analytical-only (T1) | 204 |
| | external-replication (published numbers) | 4 |
| | **subtotal** | **208** |
| No numerical evidence yet | unverified | 754 |
