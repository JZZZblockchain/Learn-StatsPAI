...
- **`sp.rlasso` — rigorous (data-driven) Lasso, a faithful port of R's
  ...
  Coverage: `tests/reference_parity/test_rlasso_parity.py` (14 pins vs
  `hdm`, generated by `_generate_rlasso.R`) and `tests/test_rlasso.py`
  (22 behavioural/edge tests). References (verified): `belloni2012sparse`
