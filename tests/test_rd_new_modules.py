...
class TestLocalRandomization:
    ...
    def test_rdrandinf_basic(self, data_sharp):
        ...
        result = rdrandinf(
            data_sharp, y="y", x="x", c=0, wl=-0.3, wr=0.3, n_perms=200, seed=42
        )
    ...
    def test_rdwinselect(self, data_sharp):
        ...
        result = rdwinselect(data_sharp, x="x", c=0, covs=["z"], nwindows=5, seed=42)
        assert isinstance(result, pd.DataFrame)
        assert len(result) >= 3
    ...
    def test_rdsensitivity(self, data_sharp):
        ...
        result = rdsensitivity(
            data_sharp, y="y", x="x", c=0, nwindows=5, n_perms=100, seed=42
        )
        assert isinstance(result, pd.DataFrame)
    ...
    def test_rdrbounds(self, data_sharp):
        ...
        result = rdrbounds(
            data_sharp, y="y", x="x", c=0, wl=-0.3, wr=0.3, n_perms=100, seed=42
        )
        assert isinstance(result, pd.DataFrame)
...
class TestRD2D:
    ...
    def test_rd2d_location(self, data_2d):
        ...
        result = rd2d(
            data_2d, y="y", x1="x1", x2="x2", treatment="d", approach="location"
        )
        assert isinstance(result, CausalResult)
...
class TestExtrapolation:
    ...
    def test_rd_extrapolate_basic(self, data_sharp):
        ...
        result = rd_extrapolate(
            data_sharp, y="y", x="x", c=0, covs=["z"], n_eval=5, method="ols"
        )
        assert isinstance(result, CausalResult)
    ...
    def test_rd_external_validity(self, data_sharp):
        ...
        result = rd_external_validity(data_sharp, y="y", x="x", c=0, covs=["z"])
...
class TestRDML:
    ...
    def test_rd_lasso(self, data_sharp):
        ...
        result = rd_lasso(data_sharp, y="y", x="x", c=0, covs=["z", "z2"])
        assert isinstance(result, CausalResult)
    ...
    def test_rd_forest(self, data_hte):
        ...
        result = rd_forest(data_hte, y="y", x="x", c=0, covs=["z"], n_trees=50, seed=42)
        assert isinstance(result, CausalResult)
    ...
    def test_rd_boost(self, data_hte):
        ...
        result = rd_boost(
            data_hte, y="y", x="x", c=0, covs=["z"], n_estimators=50, seed=42
        )
        assert isinstance(result, CausalResult)
    ...
    def test_rd_cate_summary(self, data_hte):
        ...
        result = rd_cate_summary(
            data_hte, y="y", x="x", c=0, covs=["z"], methods=["lasso"], seed=42
        )
        assert isinstance(result, dict)
...
class TestEnhancedRdrobust:
    ...
    def test_cerrd_bandwidth(self, data_sharp):
        ...
        result = rdrobust(data_sharp, y="y", x="x", c=0, bwselect="cerrd")
        assert isinstance(result, CausalResult)
    ...
    def test_certwo_bandwidth(self, data_sharp):
        ...
        result = rdrobust(data_sharp, y="y", x="x", c=0, bwselect="certwo")
    ...
    def test_msecomb1_bandwidth(self, data_sharp):
        ...
        result = rdrobust(data_sharp, y="y", x="x", c=0, bwselect="msecomb1")
        assert isinstance(result, CausalResult)
    ...
    def test_all_bwselect_methods(self, data_sharp):
        ...
        for method in [
            ...
            result = rdrobust(data_sharp, y="y", x="x", c=0, bwselect=method)
...
class TestEnhancedDiagnostics:
    ...
    def test_rdsummary_basic(self, data_sharp):
        ...
        result = rdsummary(data_sharp, y="y", x="x", c=0, verbose=False)
    ...
    def test_rdsummary_with_covs(self, data_sharp):
        ...
        result = rdsummary(data_sharp, y="y", x="x", c=0, covs=["z"], verbose=False)
    ...
    def test_rdsummary_full(self, data_sharp):
        ...
        result = rdsummary(
            data_sharp, y="y", x="x", c=0, covs=["z"], full=True, verbose=False
        )
