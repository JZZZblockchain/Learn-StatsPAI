...
def test_rd_distribution():
    ...
    np.testing.assert_allclose(res.qte, [-0.33078488, -0.73963088, -0.01037915], atol=5e-9)
...
def test_rd_distributional_design():
    ...
    np.testing.assert_allclose(res.rdd_effect, [-0.33078488, -0.73963088, -0.01037915], atol=5e-9)
    np.testing.assert_allclose(res.rkd_effect, [0.49336577, -0.42845392, -1.01226155], atol=5e-9)
...
def test_rd_bayes_hte():
    ...
    np.testing.assert_allclose(res.cate[:3], [1.44245025, 1.45285633, 1.45044963], atol=5e-9)
